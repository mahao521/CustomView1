...
public class RoundRectDrawableWithShadow extends Drawable {
    ...
    private void drawShadow(Canvas canvas) {
        ...
        if (drawHorizontalEdges) {
            canvas.drawRect(0, edgeShadowTop,
                    ...
                    mEdgeShadowPaint);
           /* canvas.drawRect(0, -mCornerRadius,
                    mCardBounds.width() - 2 * inset, edgeShadowTop,
                    mEdgeShadowPaint);*/
        }
        canvas.restoreToCount(saved);
        // LB
    ...
    private void buildComponents(Rect bounds) {
        ...
        mCardBounds.set(bounds.left + mRawMaxShadowSize, bounds.top + mRawMaxShadowSize,
                bounds.right - mRawMaxShadowSize, bounds.bottom - mRawMaxShadowSize);
        buildShadowCorners();
    }
