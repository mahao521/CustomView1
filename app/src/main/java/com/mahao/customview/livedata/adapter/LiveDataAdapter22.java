...
//使用修改lastVersion
public class LiveDataAdapter22 extends RecyclerView.Adapter<LiveDataAdapter22.ViewHolder> {

    private static final String TAG = "LiveDataAdapter22";
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            mTextView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    setLastVersion(mObserver, model.getLastVersionLiveData());
  ...
  /*          Field fieldVersion = classLiveData.getDeclaredField("mVersion");
            ...
            fieldLastVersion.set(objectWrapper, -1);
            Log.d(TAG, "setLastVersion: " + fieldLastVersion.get(objectWrapper));
        } catch (Exception e) {
